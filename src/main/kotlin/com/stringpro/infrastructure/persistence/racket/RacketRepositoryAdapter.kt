...
class RacketRepositoryAdapter(
    ...
    override fun save(racket: Racket): Racket =
        mongoRepository.save(racket.toDocument()).toDomain()

    override fun findById(id: String): Racket? =
    ...
    private fun Racket.toDocument() = RacketDocument(
        id = id,
    ...
    private fun RacketDocument.toDomain() = Racket(
        id = id,
        customerId = customerId,
        brand = brand,
        model = model,
